...
import pandas as pd
from  utils.plot_general import rose_plot, plot_eye_movements, plot_et_cond
...
def analyze_data():
    ...
    intercept_ev = config.events_of_interest['first_intercept_event_type']
    ...
    results = {
        'intercept_event': intercept_ev,
        'second_intercept_event': second_intercept_ev,
